...
#    print str(list(left)) + ' => ' + str(list(right)) + ' (Conf:' + str(len(support[tuple(sorted(tuple(left).__add__(tuple(right))))])*100.0/len(support[tuple(left)])) + '%, Supp: ' + str(len(support[tuple(sorted(tuple(left).__add__(tuple(right))))])*100.0/lineNum) + '%)'
#  else:
#    print str(list(left)) + ' => ' + str(list(right)) + ' (Conf:' + str(len(support[tuple(sorted(tuple(right).__add__(tuple(left))))])*100.0/len(support[tuple(left)])) + '%, Supp: ' + str(len(support[tuple(sorted(tuple(right).__add__(tuple(left))))])*100.0/lineNum) + '%)'
